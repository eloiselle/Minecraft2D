...
void Game::initShield(int nb)
{
	...
	{
		_shieldSphere.push_back(Bullet());
		_shieldVA.push_back(VectorAngle());
		_shieldVA.back().init(100, 0, 1);
		_shieldVA.back().rotate(i * (360 / nb));
	}
}
