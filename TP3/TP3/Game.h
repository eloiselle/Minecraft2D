...
public:
	...
	void shootWeapon();                                 // Utilise l'arme pour creer des bullets
	void shootPlayerBullet();                           // Tire une balle
    ...
    float distanceBetweenMP(MagnetPosition &, MagnetPosition &)const; // Calcule la distance entre deux MagnetPosition
