...
// blockIs...
bool WorldMap::blockIsTraversable(Block& cm)const { return cm.getType() == EMPTY_BLOCK; }
bool WorldMap::blockIsDestructible(Block& cm)const { return cm.getType() == SOFT_BLOCK; }
